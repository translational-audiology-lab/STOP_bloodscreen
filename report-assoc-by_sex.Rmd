---
params:
  panels: ["Inflammation", "Target 96 Neurology"]
...
if(!exists("sex")) sex <- "female" # no passover then 'female' as default
...
knitr::opts_chunk$set(
  ...
  cache.extra = c(params$panels, sex),
  fig.width  = 8,
  fig.height = 6,
...
fn <- list(
  ...
  o = list(         # intermediate results
    res = paste0("../cache/assoc-", sex, "-", 
                 paste(params$panels, collapse = ","), ".RData")
  )
)
...
All analyses below were limited to **`r sex`** participants and Olink **`r params$panels`** panel(s).
...
Especially, quite a large number of proteins were significantly associated with **age and sample lab**. 
