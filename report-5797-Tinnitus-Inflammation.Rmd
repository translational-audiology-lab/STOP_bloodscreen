...
title: "`r params$project_title` - Inflammation"
...
* Association test of individual proteins with various tinnitus related variables
    - No association test results for tinnitus reach the common threshold, adjusted _p_ value below 0.05. 
    - `FGF-21` was marginally associated with tinnitus after adjusting for BMI or Smoking.
    - No association was found between hearing problem and individual proteins.
    - `ADA` was marginally associated with headache.
    - A few proteins were found associated with tinnitus subtypes.
    - `VEGFA` was marginally associated with THI 23 (cope with).

* Stratified analysis by sex
    - Any association with tinnitus or hearing problem was not found.
    - A few proteins were found associated with tinnitus subtypes.
</div>
